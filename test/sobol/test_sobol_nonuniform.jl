...
# sampling
py_samples = load("data/sobol/py_nonuniform/py_samples.csv", header_exists=false, colnames = ["x1", "x2", "x3"]) |> DataFrame
py_ishigami = load("data/sobol/py_nonuniform/py_ishigami.csv", header_exists=false) |> DataFrame

# analysis
py_A = load("data/sobol/py_nonuniform/py_A.csv", header_exists=false) |> DataFrame
py_B = load("data/sobol/py_nonuniform/py_B.csv", header_exists=false) |> DataFrame
py_AB = load("data/sobol/py_nonuniform/py_AB.csv", header_exists=false) |> DataFrame
py_BA = load("data/sobol/py_nonuniform/py_BA.csv", header_exists=false) |> DataFrame

py_firstorder = load("data/sobol/py_nonuniform/py_firstorder.csv", header_exists=false) |> DataFrame
py_secondorder = load("data/sobol/py_nonuniform/py_secondorder.csv", header_exists=false) |> DataFrame
py_totalorder = load("data/sobol/py_nonuniform/py_totalorder.csv", header_exists=false) |> DataFrame

py_firstorder_conf = load("data/sobol/py_nonuniform/py_firstorder_conf.csv", header_exists=false) |> DataFrame
py_secondorder_conf = load("data/sobol/py_nonuniform/py_secondorder_conf.csv", header_exists=false) |> DataFrame
py_totalorder_conf = load("data/sobol/py_nonuniform/py_totalorder_conf.csv", header_exists=false) |> DataFrame
